...
class Audio {
  ...
  public:
    ...
    void             setVUSettings(uint16_t gain, uint16_t windowMs, uint16_t attackMs, uint16_t releaseMs,
...
#pragma GCC diagnostic pop
    ...
    static constexpr uint8_t VU_FRAME_QUEUE_SIZE = 64;
    vu_frame_t              m_vu_frames[VU_FRAME_QUEUE_SIZE];
    std::atomic<uint8_t>    m_vu_frame_write{0};
    std::atomic<uint8_t>    m_vu_frame_read{0};
    uint16_t                m_vu_window_samples = 0;
    uint8_t                 m_vu_window_peak_left = 0;
    uint8_t                 m_vu_window_peak_right = 0;
    std::atomic<uint16_t>   m_vu_reference{1};
    vu_frame_t              m_vu_display_frame;
    uint32_t                m_vu_frame_ms = 0;
    float                  m_vu_display_left = 0;
    float                  m_vu_display_right = 0;
    float                  m_vu_display_peak_left = 0;
    float                  m_vu_display_peak_right = 0;
    uint32_t               m_vu_display_peak_hold_left = 0;
    uint32_t               m_vu_display_peak_hold_right = 0;
    uint32_t               m_vu_display_ms = 0;
    std::atomic<uint16_t>   m_vu_gain{100};
    std::atomic<uint16_t>   m_vu_window_ms{10};
    std::atomic<uint16_t>   m_vu_attack_ms{160};
    std::atomic<uint16_t>   m_vu_release_ms{320};
    std::atomic<uint16_t>   m_vu_peak_hold_ms{120};
    std::atomic<uint16_t>   m_vu_peak_release_ms{700};
